	...
	<script type="text/javascript">
	      function checkValue()
	        ...
	        function openIDCheck(){
	        	...
	        	window.open("consumer_IdCheckForm.do","아이디 중복 확인", "width=500, height=200, resizable=no, scrollbars=no");
	        }
    </script>
</head>
<body>
  ...
  <div class="col-sm-2"></div>
   <div class="col-sm-8 text-left"> 
	<form name = "f" action = "consumer_Input.do" method = "post" onsubmit="return checkValue()">
		<table class="table">
  				<tr>
					<td colspan="2" align=center>일반회원가입</td>
 				</tr>
				<tr>
					<td width="150">아이디</td>
					<td class="m3">
						<input type="text" name="consumer_ID" id="consumer_ID" placeholder="아이디" readOnly>
  				...
  				<tr>
					...
					<td class="m3">
						<input type="password" name="consumer_Password" placeholder="비밀번호" >
					</td>
  				</tr>
  				<tr>
                ...
                <tr>
  				...
  				<tr>
					<td colspan="2" align="center">
						...
						<input type="button" value="취소" onclick="goLoginForm()"  class="btn btn-secondary">
					</td>
  				</tr>
  			</table>
	</form>
