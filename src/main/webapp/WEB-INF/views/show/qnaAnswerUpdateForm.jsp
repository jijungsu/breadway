...
<form name = "qnA" action = "marketer_quest_updateForm_ok.do" method="post">
		<input type = "hidden" name = "show_ID" value = "${show_ID}">
		<input type="hidden" name="num" value="${getQuest.num}" />
	<table border = "0" width = "80%" class="table">
		<tr>
			<th colspan="2"><h2>답 글 수 정</h2></th>
		</tr>
		<tr>
			<th width ="100">문의자</th>
			<td>
		...
		<tr>
			<th>문의내용</th>
			<td>
				<textarea name = "qna_reContent" rows="10" cols="100%"  class="form-control">${getQuest.qna_reContent}</textarea>
			</td>
		</tr>
		<tr>
			<td colspan = "2">
