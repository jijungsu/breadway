 ...
 <c:import url="/top.do">
	...
	<div class="container" style="margin-top:30px">
	    ...
	    <div class="container" style="padding-top:30px; padding-bottom:30px;">
    		...
    		<thead>
    			<tr>
    				<td colspan="2" align="center" height="10">예매취소내역확인</td>
    			</tr>
    		</thead>
    		<tbody>
    			<tr height="100%" valign="middle">
    				...
    				<tr>
    					<td>취소날짜 </td>
    					<td>${show[0].RESERVE_CANCEL_DATE}</td>
    				</tr>
    				<tr>
    					<td>관람일시 </td>
    				...
    				<tr>
    					...
    					<td><c:set var = "total" value = "0" />
							...
							${total * (100-show[0].SEAT_DISCOUNT)/10000*percent}원</td>
    				</tr>
    				</table>
    				</div>
    				</td>
...
.hidden {
    ...
    <table border="1" align="center" width="800" height="650">
    	...
    	<th colspan="3" valign="top" align="center">예매취소내역확인<br>
    		<table border="1" width="80%" height="500" align="center">
    			...
    			<tr height="90%">
    				...
    				예매번호 : ${show[0].ORDER_NUM}<br>
    				취소날짜 : ${show[0].RESERVE_CANCEL_DATE}<br>
    			...
    			<tr  height="30%" >
    				...
    				<c:set var = "total" value = "0" />
							...
							${total * (100-show[0].SEAT_DISCOUNT)/10000*percent}
    				</td>
    			</tr>
    			<tr>
    		</table>
